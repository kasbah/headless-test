...
;(async () => {
  ...
  const testUrl = 'https://eu.mouser.com/Search/Refine?Keyword=NE555P'
  await page.goto(testUrl)

  await page.waitForNavigation()

  await page.waitForSelector('.available-amount')
  console.log(page.url())

  const avail = await page.$eval('.available-amount',  n => n.innerText)
  console.log('stock:', avail.replace('.', ','))
